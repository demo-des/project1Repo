...
- Create Angular project with ng: `ng new demo-solution.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`demo-solution.client.esproj`).
